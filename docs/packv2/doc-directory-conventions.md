...
Holds pack-wide skills.

Use this for reusable skills shipped with a pack and made available according to pack and agent composition rules.

Per-agent skills belong under `agents/<name>/skills/`.

### `mcp/`

Holds pack-wide MCP server definitions or related MCP assets.
...
- `overlays/`, `skills/`, `mcp/`, `template-fragments/` mean "load pack-wide assets of those kinds"
